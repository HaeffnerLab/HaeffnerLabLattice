...
class PAULBOX_CONTROL( QtGui.QWidget ):
    ...
    def loadscriptnames( self ):
        for name in self.pbox.availableScripts():
    ...
    def scriptSelected( self, item ):
        ...
        varlist = self.pbox.variableList( selectedname )
    ...
    def executeScript( self ):
        ...
        self.pbox.sendcommand( name, varlist )

app = QtGui.QApplication( sys.argv )
icon = PAULBOX_CONTROL()
icon.show()
app.exec_()
