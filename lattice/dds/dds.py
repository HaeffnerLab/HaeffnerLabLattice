...
xem.ConfigureFPGA("/Users/thanedp/Dropbox/WORK/VHDL/XEM6010/Photon_sd_ram_2012_05_10/photon/photon.bit")
...
xem.WriteToBlockPipeIn(0x81, 2, "\x00\x00\x00\xff")
...
time.sleep(0.25)
xem.WriteToBlockPipeIn(0x81, 2, "\x00\x00\x00\xff")
xem.WriteToBlockPipeIn(0x81, 2, "\x00\x10\x00\xff")
xem.WriteToBlockPipeIn(0x81, 2, "\x00\x20\x00\xff")
xem.WriteToBlockPipeIn(0x81, 2, "\x00\x30\x00\xff")
xem.WriteToBlockPipeIn(0x81, 2, "\x00\x40\x00\xff")
xem.WriteToBlockPipeIn(0x81, 2, "\x00\x50\x00\xff")
xem.WriteToBlockPipeIn(0x81, 2, "\x00\x60\x00\xff")
xem.WriteToBlockPipeIn(0x81, 2, "\x00\x70\x00\xff")
xem.WriteToBlockPipeIn(0x81, 2, "\x00\x00\x00\x00")
...
xem.UpdateWireIns()
time.sleep(0.25)
xem.WriteToBlockPipeIn(0x81, 2, "\x00\x20\x00\x2f")
