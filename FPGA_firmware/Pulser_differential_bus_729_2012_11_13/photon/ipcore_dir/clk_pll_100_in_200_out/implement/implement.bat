...
xst -ifn xst.scr
move clk_pll_100_in_200_out_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk_pll_100_in_200_out_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_pll_100_in_200_out_exdes.ucf clk_pll_100_in_200_out_exdes

echo 'Running map'
map -timing -pr b clk_pll_100_in_200_out_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clk_pll_100_in_200_out_exdes -w routed.ncd routed.vhd
cd ..
