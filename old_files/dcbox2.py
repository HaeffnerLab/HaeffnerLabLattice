...
class DCBoxServer( SerialDeviceServer ):
    ...
    def createDict( self ):
        ...
        """
        d = {}
        devTup = ( 'endcap', 'comp', 'shutter' )
        for dev in devTup:
            d[dev] = {'devChannels':{}}
        endcap = ( ( 1, 1 ), ( 2, 0 ) )
        comp = ( ( 1, 4 ), ( 2, 2 ), ( 'common', 3 ) )
        shutter = ( ( 1, 5 ), ( 2, 6 ), ( 3, 7 ) )
        chanTup = ( endcap, comp, shutter )
        ...
        rangeTup = ( ecRange, compRange, shutterRange )
    ...
    def writeToSerial( self, channel, value ):
        ...
        Lock up further writes for specified wait time.
        Convert message to microcontroller's syntax.
        Save written value to memory.
