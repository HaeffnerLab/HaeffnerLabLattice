...
from scripts.PulseSequences.branching_ratio import branching_ratio as sequence
from scripts.PulseSequences.branching_ratio import sample_parameters
...
class branching_ratio(SemaphoreExperiment):
    ...
    def initialize(self):
        ...
        self.setup_pulser()
        self.binner = Binner(self.timetag_record_cycle['s'], 0.5e-6)
    ...
    def program_pulser(self):
        ...
        self.timetag_record_cycle = seq.timetag_record_cycle
