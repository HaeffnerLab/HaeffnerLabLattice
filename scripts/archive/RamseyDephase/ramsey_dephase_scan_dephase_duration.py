...
class ramsey_dephase_scan_dephase_duration(experiment):
    
    name = 'RamseyDephaseScanDuration'
    required_parameters = [
    ...
    def setup_data_vault(self):
        ...
        window_name = self.parameters.get('RamseyDephaseScanDuration.window_name', ['RamseyDephaseScanDuration'])
    ...
    def run(self, cxn, context):
        ...
        for i,duration in enumerate(self.scan):
            ...
            self.parameters['RamseyDephase.dephasing_duration'] = duration
...
if __name__ == '__main__':
    ...
    exprt = ramsey_dephase_scan_dephase_duration(cxn = cxn)
