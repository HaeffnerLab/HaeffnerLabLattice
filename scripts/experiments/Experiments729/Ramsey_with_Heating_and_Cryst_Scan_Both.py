...
class ramsey_with_heating_and_cryst_scan_both(experiment):
    
    name = 'Ramsey_with_Heating_Pulse_and_Cryst_Scan_Both'
    ...
    def data_vault_new_trace(self):
        ...
        window_name = ['Ramsey with Heating - Scan Ramsey Gap + Phase and Blue Pulse']
        ...
        window_name = ['Dephasing, Contrast - Scan Ramsey Gap + Phase and Blue Pulse']
    ...
    def run(self, cxn, context):
        ...
        for i,interaction_duration in enumerate(self.scan_t):
            ...
            self.parameters.Heating.blue_heating_delay_before = WithUnit(0.0, 'us');
            self.parameters.Heating.blue_heating_delay_after = WithUnit(0.0, 'us');
            
            self.parameters.Heating.blue_heating_duration = ramsey_time - (frequency_advance_duration + self.parameters.Heating.blue_heating_repump_additional)
...
if __name__ == '__main__':
    ...
    exprt = ramsey_with_heating_and_cryst_scan_both(cxn = cxn)
