...
class scan_phase_of_second_pulse(experiment):
    
    name = 'Dephasing with 729: scan phase of second pulse'
    required_parameters = [
                           ('Dephasing','first_pulse_duration'),
                           ('Dephasing','second_pulse_duration'),
    ...
    def setup_sequence_parameters(self):
        ...
        self.parameters['Ramsey.second_pulse_duration'] = self.parameters.Dephasing.second_pulse_duration
...
if __name__ == '__main__':
    ...
    exprt = scan_phase_of_second_pulse(cxn = cxn)
