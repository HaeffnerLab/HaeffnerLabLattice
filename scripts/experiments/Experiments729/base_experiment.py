...
class base_experiment(experiment):
    ...
    def all_required_parameters(cls):
        params = cls.experiment_required_parameters
        params.extend(cls.excitation.all_required_parameters())
        #removing parameters we'll be overwriting, and they do not need to be loaded
        params.remove(('Excitation_729','rabi_excitation_amplitude'))
        params.remove(('Excitation_729','rabi_excitation_duration'))
        params.remove(('Excitation_729','rabi_excitation_frequency'))
        return params
    
    def initialize(self, cxn, context, ident):
        self.ident = ident
        self.excite = self.make_experiment(self.excitation)
