...
class rabi_tomography(experiment):
    ...
    def run(self, cxn, context):
        ...
        for i,iteration in enumerate(self.scan):
            ...
            self.parmeters['Tomography.iteration'] = iteration
            self.parmeters['StateReadout.repeat_each_measurement'] = self.parameters.Tomography.repeat_each_measurement
