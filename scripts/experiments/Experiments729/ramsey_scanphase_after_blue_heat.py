...
from excitation_blue_heat_ramsey import excitation_ramsey_blue_heat
...
class ramsey_scanphase_after_blue_heat(experiment):
    
    name = 'RamseyScanPhaseAfterBlueHeat'
    required_parameters = [
    ...
    required_parameters.extend(excitation_ramsey_blue_heat.required_parameters)
    ...
    def initialize(self, cxn, context, ident):
        self.ident = ident
        self.excite = self.make_experiment(excitation_ramsey_blue_heat)
...
if __name__ == '__main__':
    ...
    exprt = ramsey_scanphase_after_blue_heat(cxn = cxn)
