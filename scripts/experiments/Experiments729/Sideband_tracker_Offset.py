...
class Sideband_tracker(experiment):
    ...
    name = 'Sideband_tracker_offset' # New name
    ...
    spectrum_required_parameters = [
                           ...
                           #('Sideband_tracker','mode_offset'), # Manual offset # Ahmed
    ...
    def fit_center_freq(self, cxn, context):
        ...
        if accepted:
            ...
            print fitted_freq
            result = WithUnit(np.abs(fitted_freq - self.carrier_frequency),'MHz') # Ahmed add here: + radial_frq_offset
