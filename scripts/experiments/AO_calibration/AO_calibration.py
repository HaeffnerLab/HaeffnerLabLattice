...
class AO_calibration(experiment):
    ...
    def get_calibrated_frequency_scan(self,calibrated_power,step):
        ...
        self.power_meter.set_wavelength(397)
        ...
        for i,frequency_397 in enumerate(self.scan):
            ...
            self.pulser.amplitude('global397', WithUnit(amplitude, 'dBm'))
            print amplitude
            self.pulser.frequency('global397', frequency_397)
    ...
    def calibrated_scan(self,calibrated_power):
        ...
        for i,frequency_397 in enumerate(self.scan):
            ...
            self.pulser.amplitude('global397',WithUnit(calibrated_power[i],'dBm'))
            ...
            #print frequency_397
            self.dv.add([frequency_397_no_unit,averaged_power],context=self.light_power_v_frequency_save_context) 
