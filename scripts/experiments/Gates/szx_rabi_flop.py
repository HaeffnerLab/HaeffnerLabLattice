...
from excitations import  szx_rabi
...
class szx_rabi_flop(experiment):
    ...
    def all_required_parameters(cls):
        ...
        parameters = parameters.union(set(szx_rabi.all_required_parameters()))
    ...
    def initialize(self, cxn, context, ident):
        self.ident = ident
        self.excite = self.make_experiment(szx_rabi)
    ...
    def setup_data_vault(self):
        ...
        window_name = self.parameters.get('SZX.window_name', ['SZX Rabi Flop'])
