...
class vaet_scan_local_stark_detuning(experiment):
    
    name = 'VAET_ScanLocalStarkDetuning'
    trap_frequencies = [
    ...
    def setup_data_vault(self):
        ...
        if self.grapher is not None:
            self.grapher.plot_with_axis(ds, 'vaet_local_stark_detuning', self.scan)
...
if __name__ == '__main__':
    ...
    exprt = vaet_scan_local_stark_detuning(cxn = cxn)
