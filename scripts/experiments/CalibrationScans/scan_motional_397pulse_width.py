...
class scan_motional_397pulse_width(experiment):

    name = 'ScanMotional397PulseWidth'    
    required_parameters = [                                                      
                           ('Motion_Analysis','scan_pulse_width_397')                           
                           ]
    ...
    def all_required_parameters(cls):
        ...
        parameters.remove(('Motion_Analysis','pulse_width_397'))
        return parameters
...
if __name__ == '__main__':
    ...
    exprt = scan_motional_397pulse_width(cxn = cxn)
