...
if __name__ == '__main__':
    ...
    for (collection,param), value in test_parameters.parameters.iteritems():
        ...
        if not (collection,param) in rabi_tomography.required_parameters:
...
#        a.pop(key)
#        try:
#            sequence = rabi_tomography(a)
#        except Exception:
#            pass
#        else:
#            print 'key not needed', key
    tinit = time.time()
    cs = rabi_tomography(d)
