...
class ramsey_2ions_excitation(pulse_sequence):
    ...
    def sequence(self):
        ...
        self.addDDS('729', self.end, frequency_advance_duration, p.ion1_excitation_frequency1+detuning, ampl_off)
        self.addDDS('729_1', self.end, frequency_advance_duration, p.ion1_excitation_frequency2+detuning, ampl_off)        
        self.addDDS('729_aux', self.end, frequency_advance_duration, p.ion2_excitation_frequency1+detuning, ampl_off)
        self.addDDS('729_aux_1', self.end, frequency_advance_duration, p.ion2_excitation_frequency2+detuning, ampl_off)
        self.end = self.end + frequency_advance_duration
        
        ###first rabi excitation on ion1###
        self.addDDS('729', self.end, p.ion1_excitation_duration1, p.ion1_excitation_frequency1+detuning, p.ion1_excitation_amplitude1)
        ...
        self.addDDS('729_1', self.end, p.ion1_excitation_duration2, p.ion1_excitation_frequency2+detuning, p.ion1_excitation_amplitude2)
        ...
        self.addDDS('729_aux', self.end, p.ion2_excitation_duration1, p.ion2_excitation_frequency1+detuning, p.ion2_excitation_amplitude1,WithUnit(0.0,'deg'))
        ...
        self.addDDS('729_aux_1', self.end, p.ion2_excitation_duration2, p.ion2_excitation_frequency2+detuning, p.ion2_excitation_amplitude2,WithUnit(0.0,'deg'))
        ...
        ###undoing stuff###
        ###second rabi excitation on ion2###                
        self.addDDS('729_aux_1', self.end, p.ion2_excitation_duration2, p.ion2_excitation_frequency2+detuning, p.ion2_excitation_amplitude2, WithUnit(180.0,'deg'))
        self.end = self.end + p.ion2_excitation_duration2 + gap
        ###first rabi excitation on ion2###
        #self.addDDS('729_aux', self.end, p.ion2_excitation_duration1, p.ion2_excitation_frequency1+detuning, p.ion2_excitation_amplitude1,p.ion2_excitation_phase1)
        self.addDDS('729_aux', self.end, p.ion2_excitation_duration1, p.ion2_excitation_frequency1+detuning, p.ion2_excitation_amplitude1,WithUnit(0.0,'deg'))
        self.end = self.end + p.ion2_excitation_duration1 + gap
