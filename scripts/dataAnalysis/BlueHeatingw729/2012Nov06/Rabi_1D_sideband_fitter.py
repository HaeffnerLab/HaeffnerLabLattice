...
info = [
(0, 0.0, ('2012Nov06','1953_40'), 100e-6, {'nbar': Parameter(50), 'delta': 0.0, 'T_Rabi' : Parameter(38.4e-6)}),       
(0, 100.0, ('2012Nov06','1955_21'), 100e-6, {'nbar': Parameter(400), 'delta': 0.0, 'T_Rabi' : Parameter(38.4e-6)}),
(0, 200.0, ('2012Nov06','1956_17'), 100e-6, {'nbar': Parameter(1000.0), 'delta': 0.0, 'T_Rabi' : Parameter(30.4e-6)}),
(0, 350.0, ('2012Nov06','1959_17'), 100e-6, {'nbar': Parameter(2000.0), 'delta' : 0.0, 'T_Rabi' : Parameter(30.4e-6)}),
(0, 500.0, ('2012Nov06','1957_46'), 100e-6, {'nbar': Parameter(2000.0), 'delta' : 0.0, 'T_Rabi' : Parameter(30.4e-6)}),
#(0, 100.0, ('2012Nov06','1937_34'), 100e-6, {'nbar': Parameter(400.0), 'delta' : 0.4, 'T_Rabi' : Parameter(30.4e-6)}),
]
...
for number,trace in enumerate(info):
    ...
    #plotting
    pyplot.plot(10**6 * detailed_times , evolution, 'b',linewidth=3)
