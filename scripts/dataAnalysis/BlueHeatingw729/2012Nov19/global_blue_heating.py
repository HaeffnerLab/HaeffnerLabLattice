...
info = [
(0, 0.0, ('2012Nov15','1835_14'), 20e-6, {'nbar': Parameter(22.0), 'delta': 0.0, 'T_Rabi' : Parameter(16.4e-6)}),       
(0, 10.0, ('2012Nov15','1837_34'), 20e-6, {'nbar': Parameter(60.0), 'delta': 0.0, 'T_Rabi' : Parameter(16.4e-6)}),
(0, 20.0, ('2012Nov15','1838_47'), 20e-6, {'nbar': Parameter(100.0), 'delta': 0.0, 'T_Rabi' : Parameter(16.4e-6)}),
(0, 40.0, ('2012Nov15','1840_18'), 45e-6, {'nbar': Parameter(200.0), 'delta' : 0.0, 'T_Rabi' : Parameter(16.4e-6)}),
(0, 60.0, ('2012Nov15','1842_05'), 45e-6, {'nbar': Parameter(200.0), 'delta' : 0.0, 'T_Rabi' : Parameter(23.8e-6)}),
]
...
for number,trace in enumerate(info):
    ...
    def f(x): 
        ...
        return evolution
    #get data
    dv.cd( ['','Experiments','729Experiments','BlueHeating',date,datasetName] )
    dv.open(1)  
