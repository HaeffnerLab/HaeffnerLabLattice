...
dv = cxn.data_vault
dv.cd('','Experiments','BareLineScan','2013Nov16','1518_47')
dv.open(3)
...
dv.cd('','Experiments','BareLineScan','2013Nov16','1547_14')
dv.open(3)
data2=dv.get().asarray

data2_y = data2[:,1]/29.0
data2_yerr = np.sqrt(data2[:,1])/29.0
data2_x = data2[:,0]+41.9
...
pyplot.plot(np.arange(120,320,0.1)-params['center'],micro_model(params,np.arange(120,320,0.1))/normalization)
pyplot.show()