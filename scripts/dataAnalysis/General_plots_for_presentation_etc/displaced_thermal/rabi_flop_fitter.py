...
#         pyplot.ylabel('Excitation', fontsize = 20)
        ...
        pyplot.savefig('displaced_thermal_plots.pdf', dpi = 600)
        pyplot.show()
    
    def display_rabi_coupling():
        eta = 0.05
        for sideband in [0, -1,-2,-3,-4,-5]:
...
#         fig.set_size_inches(9,9)
        pyplot.savefig('sideband_coupling.pdf', dpi = 600)
        pyplot.show()
