...
info = ('Sideband', ('2013Oct09','1858_49')); alpha_guess = 25.0; max_range = 13; excitation_scaling = 0.5; sideband_order = -1
...
params.add('nbar', value = 3.15, min = 0.0, max = 200.0, vary = False)
