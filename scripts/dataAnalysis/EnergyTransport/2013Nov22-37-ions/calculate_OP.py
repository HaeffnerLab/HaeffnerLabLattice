...
'''
date = '2013Nov22'; comparing_flops = ('1609_05', '1612_42'); repetitions = 100.; #37 ions
...
data = dv.get().asarray
data = data.transpose()
times_pumped, probs_pumped = data[0],data[2]
dv.cd( ['','Experiments','RabiFlopping',date,original_name])
dv.open(1)
data = dv.get().asarray
data = data.transpose()
times_original, probs_original = data[0],data[2]
