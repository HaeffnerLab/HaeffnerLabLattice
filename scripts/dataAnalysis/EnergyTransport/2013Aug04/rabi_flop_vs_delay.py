...
#         ('2013Sep04', '2219_50', 'magenta'), #2000
#         ('2013Sep04', '2222_19', 'orange'), #10000
#         ('2013Sep04', '2255_17', 'pink'), #15000
#         ('2013Sep04', '2249_41', 'pink'), #20000
#         ('2013Sep04', '2305_48', 'pink'), #30000
        ]
ion_selection = 0
...
pyplot.tight_layout()
pyplot.savefig('Heating short delay, Ion {}.png'.format(ion_selection))
pyplot.show()