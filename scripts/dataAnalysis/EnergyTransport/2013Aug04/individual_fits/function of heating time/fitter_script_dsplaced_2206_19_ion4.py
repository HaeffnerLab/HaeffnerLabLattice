...
params.add('time_2pi', value = 3.496777, vary = 0) #microseconds
params.add('nbar', value = 2.543291, min = 0.0, max = 200.0, vary= 0)
params.add('alpha', value = 7.0, min = 0.0, max = 200.0, vary = 1)
'''
load the dataset
'''
