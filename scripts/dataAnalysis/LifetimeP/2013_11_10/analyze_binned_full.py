...
print peak_397_area
print peak_397_area_sigma

#corresponding background of area of the 397 peak
#background_397_domain = (54.5, 106.0)
...
#print '397 background subtracted area is {0:.5e} with unceratiny of {1:.2e} or relative uncertainty of {2:.2e}'.format(background_subtracted_397_area , background_subtracted_397_area_sigma, background_subtracted_397_area_sigma / background_subtracted_397_area)
