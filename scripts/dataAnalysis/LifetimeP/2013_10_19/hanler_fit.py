...
params.add('amplitude', value = 30000)
params.add('gamma', value = 3)
params.add('offset', value = 100000)

x_data = (np.array([1.0,3.0,4.0,2.0,2.5,3.5,4.5,5.5,6.0])) #11.1
y_err = np.array([547,567,566,556,564,566,566,667,678])
y_data = np.array([107434,118143,120876,113868,117623,121666,121649,124694,126734])
