...
toprint =  'Background-subtracted area of 866 is {0:.3e}, with uncertainty {1:.2e} with contribution from area {2:.2e} and background estimation {3:.2e}. Relative uncertainty is {4:.2e}'
