...
dv = cxn.data_vault
trap_frequency = T.Value(2.5, 'MHz') #Hz
...
#heating times in ms
fig_title = 'Heating rate'
info = [
(0, 0.0, ('2012Dec10','2032_22'), 50e-6, {'nbar': Parameter(22.0), 'delta': 0.0, 'T_Rabi' : Parameter(10.4e-6)}),       
(0, 100.0, ('2012Dec10','2033_45'), 50e-6, {'nbar': Parameter(60.0), 'delta': 0.0, 'T_Rabi' : Parameter(10.4e-6)}),
(0, 250.0, ('2012Dec10','2040_03'), 50e-6, {'nbar': Parameter(100.0), 'delta': 0.0, 'T_Rabi' : Parameter(10.4e-6)}),
]
...
ax0.set_xlabel('Heating time (ms)')
ax0.set_ylabel('nbar')
...
heating_time = np.array([0, 100, 250])
nbar = np.array([74.161, 118.957, 182.0])

p,success = fit(f, [m, b], y = nbar, x = heating_time)
print p,success

ax0.annotate('heating rate = {:.3f} nbar/ms'.format(p[0]),xy=(100, 100))
