...
flop_files = ['0026_28','0032_30','0040_06','0055_11','0101_12','0108_49','0116_16','0122_18','0130_04']
...
dephase_files = ['0029_59','0037_26','0045_03','0058_32','0106_09','0112_10','0119_38','0127_15','0135_01']
...
#pyplot.legend()
pyplot.text(xmax*0.70*10**6,0.13, 'nbar = {:.2f}'.format(nb()))
pyplot.text(xmax*0.70*10**6,0.18, 'Rabi Frequency f = {:.2f} kHz'.format(f_Rabi()*10**(-3)))
