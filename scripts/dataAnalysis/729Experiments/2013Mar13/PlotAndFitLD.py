...
# set to right date
date = '2013Mar13'
## DRIFTED OUT!! DATA NO GOOD!! (SEE NOTEBOOK)
#provide list of Rabi flops - all need to have same x-axis
flop_directory = ['','Experiments','RabiFlopping',date]
flop_files = ['2257_34','2300_47','2304_00','2307_13','2310_26','2313_39','2316_52','2320_05','2323_17']
...
dephase_files = ['2259_16','2302_29','2305_42','2308_55','2312_08','2315_21','2318_34','2321_47','2324_59']
...
sideband = 1.0
trap_frequency = U.WithUnit(2.8372,'MHz')
amax=1000.0
f_Rabi_init = U.WithUnit(120.0,'kHz')
nb_init = 0.2
delta_init = U.WithUnit(1.0,'Hz')
fit_range_min=U.WithUnit(0.0,'us')
fit_range_max=U.WithUnit(220.0,'us')
