...
throw_away = [45, 122, 124, 153, 167, 222, 226, 237]
...
start_recording_timetags = 0.00066 #doppler cooling , doppler cooling repump additional, sequence start, turn of all time
cycle_time = 0.000125
bin_size = 10e-9
print timetags.min()
print timetags.max()
