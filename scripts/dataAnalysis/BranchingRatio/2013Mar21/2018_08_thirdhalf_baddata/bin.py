...
print np.where(iterations > 686)

iterations = iterations[np.where(iterations > 1060)]
timetags = timetags[np.where(iterations > 1060)]

iterations = iterations[np.where(iterations < 1900)]
timetags = timetags[np.where(iterations < 1900)]
