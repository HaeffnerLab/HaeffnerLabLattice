...
path = os.path.join(basepath, "agilent_N5747A.ui")
...
class agilent_N5747A(QtGui.QFrame, widget_ui):
    ...
    def connect(self):
        ...
        yield self.cxn.add_on_connect('Agilent N5747A',self.reinitialize)
        yield self.cxn.add_on_disconnect('Agilent N5747A',self.disable)
    ...
    def populate_gui(self):
        server = yield self.cxn.get_server('Agilent N5747A')
...
class magnet_Control(agilent_N5747A):
    
    GPIB_device_ID = 'lattice-imaging GPIB Bus - USB0::0x0957::0x0807::N5747A-US13M3365M'
